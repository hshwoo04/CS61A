...
(define (pow b n)
  (cond
  ((equal?(remainder n 2) 1) (* b (pow b (- n 1))))
  (else 
    (cond 
      (equal? (remainder n 2) 0)((define b (square b))(define n (/ n 2)))(pow b n))
      (else (define n (/ n 2)))(pow b n))
...
(define (derive-product exp var)
  (make-sum (make-product (multiplier exp) (derive (multiplicand exp) var))(make-product (multiplier exp) (derive (multiplicand exp) var))))
